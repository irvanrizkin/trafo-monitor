...
export default function Chart({
    ...
    const metricChart = {
        labels: metrics
            .reverse()
            .map((metric) => new Date(metric.created_at).toLocaleTimeString()),
        datasets: [
            {
                label: "Metric",
                            ...
                            <Grid item xs={12} md={6}>
                                ...
                                <Card>
                                    <CardContent sx={{ textAlign: "center" }}>
                                        ...
                                        >
                                            {aggregateResult(property).count}
                                        </Typography>
                                    </CardContent>
                                </Card>
                            </Grid>
